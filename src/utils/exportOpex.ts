...
export const exportOpexToExcel = (actividades: ActividadAmbiental[]) => {
  ...
  const excelData = opexActivities.map(item => {
    ...
    return {
      ...
      "Aplica Ajuste Tarifario": opx.aplicaAjusteTarifario || "",
      "Fecha del Ajuste Tarifario": opx.fechaAjusteTarifario || "",
      "Aplica Reajuste de tarifas por tablas salariales": opx.aplicaReajusteTablasSalariales || "",
